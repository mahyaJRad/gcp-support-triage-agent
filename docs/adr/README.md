...
Lightweight MADR format. Each record captures one decision, the alternatives
considered, and the trade-off, so the reasoning is visible rather than just the
outcome.

| # | Decision | Status |
|---|----------|--------|
| 0001 | Dataset: Stack Overflow as support tickets | Accepted |
